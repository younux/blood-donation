...
def send_activation_email(user_obj, uidb64, token, domain):
    """
        Send actiation email to the given user.
...
def send_password_reset_email(user_obj, uidb64, token, domain):
    """
